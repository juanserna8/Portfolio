        ...
        <div className="flex items-center justify-between h-20">
          ...
          <nav className="hidden md:flex md:grow">
            ...
            <ul className="flex grow flex-wrap justify-end items-center font-medium mr-4 font-encode">
              ...
              <li>
                <Link to="/blog" className="text-gray-600 hover:text-gray-900 dark:hover:text-gray-300 text-lg hover:scale-110 px-5 py-2 flex items-center transition duration-150 ease-in-out">Projects</Link>
              </li>
              <li>
