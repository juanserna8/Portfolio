        ...
        <div className='font-poppins max-w-3xl mx-auto'>
          ...
          <div className='grid grid-cols-12 mt-6 gap-2'>
            ...
            <div className='col-span-7 grid grid-cols-5 md:content-start md:gap-0'>
              ...
              <div className='col-span-5 hidden md:flex items-end mt-10'>
                ...
                <svg class="h-6 w-6 text-white"  width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">  <path stroke="none" d="M0 0h24v24H0z"/>  <polyline points="7 7 12 12 17 7" />  <polyline points="7 13 12 18 17 13" /></svg>
              </div>
          ...
          <form className='mt-4 pl-2 flex items-center md:hidden' action="">
            ...
            <div className='mx-auto flex justify-center'>
              <button className='text-white rounded text-sm text-center bg-teal-500 hover:bg-orange-700 shrink-0 px-2 w-[5.5rem] h-14'>
                <span>Send message</span>
              </button>
            </div>
          </form>
