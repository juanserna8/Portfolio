          ...
          <ul>{projectsDetails.map((project, index) => {
            return(
              <li key={index} className='grid mt-4'>
                <div className='flex'>
                  <p className='text-2xl text-gray-600 font-poppins dark:text-white mr-4'>{project.name}</p>
                ...
                <div className='grid grid-cols-2 gap-4'>
                  ...
                  <div>
                    ...
                    >
                      ...
                      <div 
                        className='basis-[10%] bg-gray-900/50 grid items-center'
                        onClick={() => {
                          currentSection < projectsDetails[index].info.length - 1 && handleNext();
                  ...
                  <div className='flex flex-col'>
                    ...
                    <p className='text-xl text-gray-600 dark:text-gray-400 mt-4'>{projectsDetails[index].info[currentSection].description}</p>
                  </div>
